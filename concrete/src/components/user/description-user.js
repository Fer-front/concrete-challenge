            ...
            <div className="my-2 mb-3">
                <ul className="list-unstyled d-flex align-items-center justify-content-between">
                    <li className="description-user__data__item mx-2">
                        <strong className="description-user__data__item-qtd">{props.data.user.followers}</strong> - seguidores
                    </li>
                    <li className="description-user__data__item mx-2">
                        <strong className="description-user__item-qtd">{props.data.user.following}</strong> - seguindo
                    </li>
                </ul>
            </div>

            <div className="d-flex justify-content-between mt-4">
                <a href={props.data.user.perfil} target="_blank">
